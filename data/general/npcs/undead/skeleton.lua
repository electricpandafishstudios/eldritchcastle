...
newEntity{ base = "BASE_NPC_SKELETON",
	name = "wandering skeleton", color=colors.LIGHT_SLATE,
	level_range = {1, 4}, exp_worth = 1,
	rarity = 4,
	max_life = 10,
	combat = { 	dam=2,
				damtype = DamageType.ELDRITCH,
				weakness = DamageType.SILVER_BASHING,
...
newEntity{ base = "BASE_NPC_SKELETON",
	name = "armoured skeleton warrior", color=colors.White,
